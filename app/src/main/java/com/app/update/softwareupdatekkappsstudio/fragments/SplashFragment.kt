                ...
                RemoteConfiguration(requireActivity()).initializeConfig(
                    ...
                    onSuccess = {
                        ...
                        Constants.val_fullscreen_language_from_app =
                            data.val_fullscreen_language_from_app ?: true
                        Constants.val_fullscreen_intro = data.val_fullscreen_intro ?: true
                        Constants.val_fullscreen_main_menu_scan_apps =
                            data.val_fullscreen_main_menu_scan_apps ?: true
                        Constants.val_fullscreen_main_install_apps =
                            data.val_fullscreen_main_install_apps ?: true
                        Constants.val_fullscreen_main_uninstall =
                            data.val_fullscreen_main_uninstall ?: true
                        Constants.val_fullscreen_main_system_apps =
                            data.val_fullscreen_main_system_apps ?: true
                        Constants.val_fullscreen_main_app_usage =
                            data.val_fullscreen_main_app_usage ?: true
                        Constants.val_fullscreen_main_device_info =
                            data.val_fullscreen_main_device_info ?: true
                        Constants.val_fullscreen_main_system_update =
                            data.val_fullscreen_main_system_update ?: true
                        Constants.val_fullscreen_main_settings =
                            data.val_fullscreen_main_settings ?: true
                        Constants.val_fullscreen_main_sensor =
                            data.val_fullscreen_main_sensor ?: true
                        Constants.val_fullscreen_main_restore_apps =
                            data.val_fullscreen_main_restore_apps ?: true
                        Constants.val_fullscreen_main_battery =
                            data.val_fullscreen_main_battery ?: true
                        Constants.val_fullscreen_main_android_versions =
                            data.val_fullscreen_main_android_versions ?: true
                        ...
                        Constants.val_fullscreen_scan_app_details =
                            data.val_fullscreen_scan_app_details ?: true
                        Constants.val_fullscreen_update_back =
                            data.val_fullscreen_update_back ?: true
                        Constants.val_fullscreen_update_app_details =
                            data.val_fullscreen_update_app_details ?: true
                        Constants.val_fullscreen_install_app_back =
                            data.val_fullscreen_install_app_back ?: true
                        Constants.val_fullscreen_install_app_details =
                            data.val_fullscreen_install_app_details ?: true
                        Constants.val_fullscreen_uninstall_app_back =
                            data.val_fullscreen_uninstall_app_back ?: true
                        Constants.val_fullscreen_uninstall_app_details =
                            data.val_fullscreen_uninstall_app_details ?: true
                        Constants.val_fullscreen_system_app_back =
                            data.val_fullscreen_system_app_back ?: true
                        Constants.val_fullscreen_system_app_details =
                            data.val_fullscreen_system_app_details ?: true
                        Constants.val_fullscreen_app_usage_back =
                            data.val_fullscreen_app_usage_back ?: true
                        Constants.val_fullscreen_app_usage_details =
                            data.val_fullscreen_app_usage_details ?: true
                        Constants.val_fullscreen_system_update_back =
                            data.val_fullscreen_system_update_back ?: true
                        Constants.val_fullscreen_system_update_details =
                            data.val_fullscreen_system_update_details ?: true
                        Constants.val_fullscreen_app_restore_back =
                            data.val_fullscreen_app_restore_back ?: true
                        Constants.val_fullscreen_app_restore_details =
                            data.val_fullscreen_app_restore_details ?: true
                        Constants.val_fullscreen_mobile_sensor_back =
                            data.val_fullscreen_mobile_sensor_back ?: true
                        Constants.val_fullscreen_android_details_back =
                            data.val_fullscreen_android_details_back ?: true
                        Constants.val_fullscreen_battery_details_back =
                            data.val_fullscreen_battery_details_back ?: true
                        Constants.val_fullscreen_device_details_back =
                            data.val_fullscreen_device_details_back ?: true
                        Constants.val_fullscreen_all_details_back =
                            data.val_fullscreen_all_details_back ?: true
                        Constants.val_fullscreen_setting_back =
                            data.val_fullscreen_setting_back ?: true
                        ...
                        Constants.val_native_main_menu_bottom =
                            data.val_native_main_menu_bottom ?: true
                        ...
                        Constants.val_native_android_details =
                            data.val_native_android_details ?: true
                        ...
                        Constants.val_banner_main_menu_bottom =
                            data.val_banner_main_menu_bottom ?: true
                        ...
                        Constants.val_banner_android_details =
                            data.val_banner_android_details ?: true
                    },
                    onFailure = {
    ...
    private fun showAndMove(timeIn: Long) {
        if (!shouldStart && AppUtils.isNetworkAvailable(requireContext())) {
            ...
            NativeAdUtils(requireActivity().application, "Splash").setAdCallerName("Splash")
                .loadNativeAd(
                    if (Constants.val_native_splash_bottom) getString(R.string.val_native_splash_bottom) else getString(
                        R.string.val_native_splash_top
                    ),
