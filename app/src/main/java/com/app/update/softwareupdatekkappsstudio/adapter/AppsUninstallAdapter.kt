...
class AppsUninstallAdapter(private val homeClick: HomeClick,private val appsList: List<AppInfo>, private val context: Context) :
    RecyclerView.Adapter<AppsUninstallAdapter.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_app_uninsatll_info, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.checkButton.setOnClickListener { v: View? ->
