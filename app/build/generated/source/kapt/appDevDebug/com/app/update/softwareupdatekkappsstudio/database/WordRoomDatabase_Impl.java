  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `word_table` (`word` TEXT NOT NULL, PRIMARY KEY(`word`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'd23a08a5dc269be3aaabd582f8186906')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final TableInfo _existingWordTable = TableInfo.read(db, "word_table");
        if (!_infoWordTable.equals(_existingWordTable)) {
          return new RoomOpenHelper.ValidationResult(false, "word_table(com.app.update.softwareupdatekkappsstudio.database.Word).\n"
                  + " Expected:\n" + _infoWordTable + "\n"
                  + " Found:\n" + _existingWordTable);
        }
