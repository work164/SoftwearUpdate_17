...
public final class NativeWithMediaBinding implements ViewBinding {
  @NonNull
  ...
  private NativeWithMediaBinding(@NonNull NativeAdView rootView, @NonNull ImageFilterView adAppIcon,
      @NonNull TextView adBody, @NonNull Button adCallToAction, @NonNull TextView adHeadline,
      @NonNull MediaView adMedia, @NonNull TextView ads) {
  ...
  @NonNull
  public static NativeWithMediaBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static NativeWithMediaBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.native_with_media, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static NativeWithMediaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NativeWithMediaBinding((NativeAdView) rootView, adAppIcon, adBody, adCallToAction,
          adHeadline, adMedia, ads);
    }
