...
public final class ActivityWifiBinding implements ViewBinding {
  ...
  @NonNull
  public final ToggleButton toggleWifi;

  private ActivityWifiBinding(@NonNull ConstraintLayout rootView,
      @NonNull ToggleButton toggleWifi) {
    this.rootView = rootView;
    this.toggleWifi = toggleWifi;
  }
  ...
  public static ActivityWifiBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.toggleWifi;
      ToggleButton toggleWifi = ViewBindings.findChildViewById(rootView, id);
      if (toggleWifi == null) {
        break missingId;
      }

      return new ActivityWifiBinding((ConstraintLayout) rootView, toggleWifi);
    }
