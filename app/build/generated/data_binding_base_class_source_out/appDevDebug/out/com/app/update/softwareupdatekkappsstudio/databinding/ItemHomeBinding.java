...
public final class ItemHomeBinding implements ViewBinding {
  ...
  private ItemHomeBinding(@NonNull ConstraintLayout rootView, @NonNull ShapeableImageView homeImage,
  ...
  public static ItemHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.home_image;
      ShapeableImageView homeImage = ViewBindings.findChildViewById(rootView, id);
      if (homeImage == null) {
        break missingId;
      }

      id = R.id.home_text1;
      TextView homeText1 = ViewBindings.findChildViewById(rootView, id);
      if (homeText1 == null) {
        break missingId;
      }
      ...
      return new ItemHomeBinding((ConstraintLayout) rootView, homeImage, homeText1, itemCount);
    }
