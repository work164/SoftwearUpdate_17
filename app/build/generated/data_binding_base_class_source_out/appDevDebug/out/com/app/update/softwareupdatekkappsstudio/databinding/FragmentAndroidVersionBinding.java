...
public final class FragmentAndroidVersionBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static FragmentAndroidVersionBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentAndroidVersionBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_android_version, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentAndroidVersionBinding bind(@NonNull View rootView) {
